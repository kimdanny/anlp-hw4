...
def main(args):
    ...
    # lamp1000 means that each LaMP dev set is subsampled by the first 1000 queries.
    INF_RESULTS_DIR_PATH = os.path.join(
        CUR_DIR_PATH, "inference_results", MODEL_NAME, "lamp1000"
    )
    ...
    # get baseline metric score (m) and attach to baseline_df
    ...
    # get augment metric score (m') and attach to augment_df
    ...
    # calculate delta = m'-m and attach to augment_df_joined
